...
class ShipmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shipment" do
    assert_difference("Shipment.count") do
      post shipments_url, params: { shipment: { shipment_date: @shipment.shipment_date, shipment_id: @shipment.shipment_id } }
    end
  ...
  test "should update shipment" do
    patch shipment_url(@shipment), params: { shipment: { shipment_date: @shipment.shipment_date, shipment_id: @shipment.shipment_id } }
